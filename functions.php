...
add_action("wp_enqueue_scripts", function() {
    ...
    wp_enqueue_style("cmgalaxy-sidebar-modern", get_template_directory_uri() . "/assets/css/sidebar-modern.css", array('docy-root'), DOCY_VERSION . '.13');
});

// Remove specific empty paragraphs generated by the editor or API
function cmgalaxy_remove_empty_nbsp_paragraphs($content) {
    // Removes the exact string requested by the user
    $content = str_replace('<p style="text-align: left;">&nbsp;</p>', '', $content);
    // Also remove generic empty paragraph just in case
