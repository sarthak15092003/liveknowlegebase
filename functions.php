...
add_action("wp_enqueue_scripts", function() {
    // Version .7 = force cache bust for single post TOC scroll fix (2026-08-03)
    wp_enqueue_style("cmgalaxy-sidebar-modern", get_template_directory_uri() . "/assets/css/sidebar-modern.css", array(), DOCY_VERSION . '.7');
});
