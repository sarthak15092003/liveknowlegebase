...
add_action("wp_enqueue_scripts", function() {
    // Version .65 = force cache bust for scrollbar mockup design
    // Depends on 'docy-root' (style.css) so our overrides load last and win
    wp_enqueue_style("cmgalaxy-sidebar-modern", get_template_directory_uri() . "/assets/css/sidebar-modern.css", array('docy-root'), DOCY_VERSION . '.65');
});
