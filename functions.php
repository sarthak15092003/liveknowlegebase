...
add_action("wp_enqueue_scripts", function() {
    // Version .58 = force cache bust for related-article-link hover blue text & icon #3b82f6 (2026-08-13)
    // Depends on 'docy-root' (style.css) so our overrides load last and win
    wp_enqueue_style("cmgalaxy-sidebar-modern", get_template_directory_uri() . "/assets/css/sidebar-modern.css", array('docy-root'), DOCY_VERSION . '.58');
});
