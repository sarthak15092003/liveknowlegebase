...
add_action("wp_enqueue_scripts", function() {
    // Version .52 = force cache bust for mobile TOC dark bg & white text removal across all CSS files (2026-08-13)
    // Depends on 'docy-root' (style.css) so our overrides load last and win
    wp_enqueue_style("cmgalaxy-sidebar-modern", get_template_directory_uri() . "/assets/css/sidebar-modern.css", array('docy-root'), DOCY_VERSION . '.52');
});
