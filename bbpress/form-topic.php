                ...
                <fieldset class="bbp-form">
                    ...
                    <div class="row aq-form-wrapper">
                        ...
                        <div class="form-item col-md-12">
                            <label for="bbp_topic_title"><?php printf( esc_html__( 'Topic Title (Maximum Length: %d):', 'docy' ),
                        ...
                        <?php if ( ! ( bbp_use_wp_editor() || current_user_can( 'unfiltered_html' ) ) ) : ?>
                            ...
                            <p class="form-allowed-tags">
                                <label><?php printf( esc_html__( 'You may use these %s tags and attributes:', 'docy' ),
                        ...
                        <?php if ( bbp_allow_revisions() && bbp_is_topic_edit() ) : ?>
                            ...
                            <fieldset class="bbp-form">
                                ...
                                <div>
                                    <label for="bbp_topic_edit_reason"><?php printf( esc_html__( 'Optional reason for editing:', 'docy' ),
