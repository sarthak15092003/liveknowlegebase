                    ...
                    <div class="blog_single_item editor-content" style=" margin-top:20px; ">
                        ...
                        if ( function_exists('docy_post_breadcrumbs') ) {
                            echo '<style>
                                ...
                                .blog_single_item .breadcrumb .breadcrumb-item a:hover {
                        ...
                        while ( have_posts() ) : the_post();
                            ...
                            ?>
                            <div class="post-author-meta-box d-flex align-items-center mb-3 mt-3" style="gap: 15px; border-radius: 50px; padding: 5px;">
