...
// }
?>
<section class="blog_area tip_doc_area" id="toc_stick" style="padding-top: 0px !important; padding-bottom: 80px !important;">
                    ...
                    <div class="blog_single_item editor-content">
                        ...
                        while ( have_posts() ) : the_post();
                            ...
                            if ($is_restricted_post) {
                                if (function_exists('cmg_render_paywall_gate')) {
                                    echo cmg_render_paywall_gate(get_the_ID());
                                } else {
