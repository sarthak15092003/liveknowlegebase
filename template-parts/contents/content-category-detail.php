...
<div class="tw-cat-detail-container">
	...
	if ( $has_subcategories ) {
		...
		foreach ( $subcategories as $subcat ) {
			echo '<a href="' . esc_url(get_category_link($subcat->term_id)) . '" class="tw-cat-articles-card" style="display: block; text-decoration: none; color: inherit; transition: box-shadow 0.2s;">';
			
			// Subcategory Header
			echo '<div class="tw-subcategory-header">';
			echo '<h3 class="tw-subcategory-title" style="display: flex; align-items: center;">';
