 ...
 * Docs Nav Walker
 */
class Docy_Walker_Docs extends Walker_Page {
    /**
    ...
    public function start_el( &$output, $page, $depth = 0, $args = array(), $current_page = 0 ) {
        ...
        $thumb = '';
        if ( $depth == 0 ) {
            $folder = '<img src="' . DOCY_DIR_IMG . '/folder-closed.png" alt="' . esc_attr__('folder icon closed', 'docy') . '"> <img src="' . DOCY_DIR_IMG . '/folder-open.png" alt="' . esc_attr__('folder icon', 'docy') . '">';
