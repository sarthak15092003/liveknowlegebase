			...
			<a href="<?php echo esc_url( $term_link ); ?>" class="tw-category-card">
				...
				<div class="tw-category-content">
					...
					<div class="tw-category-meta">
						...
						echo '<div class="tw-author-avatar" style="width: 18px; height: 18px; min-width: 18px; border-radius: 50%; overflow: hidden; display: flex; align-items: center; justify-content: center;"><img src="https://docs.cmgalaxy.com/wp-content/uploads/2026/06/cropped-Group-1000004539-300x300-1.png" alt="CMGalaxy" style="width: 18px; height: 18px; object-fit: contain; display: block;"></div>';
						?>
						</div>
